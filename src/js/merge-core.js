...
/**
 * Venda pertence ao turno quando foi amarrada a ele (vendasIds ou turnoId).
 * Só venda antiga, sem turnoId, cai na faixa de horário — dois caixas abertos
 * ao mesmo tempo não podem somar a venda um do outro.
 */
export function vendaPertenceAoTurno(venda, turno) {
 ...
 */
export function dinheiroLiquidoVenda(venda) {
  if (!venda) return 0;
