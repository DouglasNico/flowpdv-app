...
import { getFirestore, doc, getDoc, getDocs, collection, onSnapshot, setDoc, updateDoc, deleteDoc, deleteField, addDoc, query, orderBy, limit, where } from "firebase/firestore";
...
export { doc, getDoc, getDocs, collection, onSnapshot, setDoc, updateDoc, deleteDoc, deleteField, addDoc, query, orderBy, limit, where };
